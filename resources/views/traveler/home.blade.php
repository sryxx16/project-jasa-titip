...
@section('title', 'Selamat Datang Traveler')
    ...
    <style>
        ...
        .order-card-sm .btn-primary {
            background-color: var(--primary-color);
            color: white;
        }

        .order-card-sm .btn-primary:hover {
...
<header class="hero" style="padding-top: 120px; text-align: center;">
    <div class="container">
        <div class="hero-content" style="max-width: 100%;">
            ...
            <p>Jadilah pahlawan bagi para penitip dan dapatkan penghasilan dari perjalanan Anda.</p>
            <div class="cta-buttons" style="justify-content: center;">
                <a href="{{ route('traveler.dashboard') }}" class="btn-primary">Lihat Semua Pesanan</a>
                <a href="{{ route('traveler.active_orders.index') }}" class="btn-secondary">Cek Pesanan Aktif</a>
            </div>
        </div>
    </div>
</header>
...
<section class="orders-showcase">
    <div class="container">
        <h2>Pesanan yang Bisa Diambil</h2>
                ...
                <div class="order-card-sm">
                    ...
                    <div class="order-content">
                        ...
                        <div class="order-actions">
                            <form method="POST" action="{{ route('traveler.orders.accept', $order) }}" style="flex: 1;">
                                @csrf
                                <button type="submit" class="btn-action btn-primary" style="width: 100%;">Terima Pesanan</button>
                            </form>
                             <a href="{{ route('customer.orders.show', $order->order_code) }}" class="btn-action btn-secondary">Detail</a>
                        </div>
                    </div>
                </div>
            @empty
                <p style="text-align: center; grid-column: 1 / -1; color: var(--gray-color);">Saat ini belum ada pesanan yang bisa diambil.</p>
            @endforelse
        </div>
    </div>
</section>
