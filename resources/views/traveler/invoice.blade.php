{{-- p/resources/views/traveler/invoice.blade.php --}}
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Invoice Pesanan - JastipKu</title>
    <style>
        body {
        ...
        .payment-row.total-pendapatan {
            color: #10b981; /* Warna hijau untuk pendapatan */
        }
    ...
    <div class="invoice-container">
        ...
        <div class="order-details">
            ...
            <div class="payment-summary">
                <h3 style="margin-top: 0; color: #4f46e5;">Rincian Pendapatan</h3>
                ...
                <div class="payment-row total total-pendapatan">
                    <span>Ongkos Jasa (Pendapatan):</span>
